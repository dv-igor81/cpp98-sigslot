@echo off
rem Скрипт сборки QuadEqMVP_gcc64.exe с помощью GCC
...
for %%F in (main ConsoleView QuadEqModel Presenter signal_impl console_settings_keeper) do (

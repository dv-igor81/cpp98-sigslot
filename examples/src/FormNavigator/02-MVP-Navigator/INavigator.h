...
//   Если текущий вид -- HomeForm, приложение завершается.
//   Иначе -- переход на HomeForm.
//
// ============================================================================
...
public:
    ...
    virtual void navigateToHome(const SharedData& data) = 0;
    virtual void navigateToData(const SharedData& data) = 0;
    virtual void navigateToResult(const SharedData& data) = 0;

    // Закрытие текущего вида (кнопка X или Exit)
    virtual void closeCurrentView(const SharedData& data) = 0;
};

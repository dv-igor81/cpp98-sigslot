@echo off
rem Скрипт сборки MatrixMVP_gcc64.exe с помощью GCC
...
for %%F in (main ConsoleView MatrixModel MatrixTypes Presenter signal_impl console_settings_keeper) do (

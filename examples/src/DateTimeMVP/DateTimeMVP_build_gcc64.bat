@echo off
rem Скрипт сборки DateTimeMVP_gcc64.exe с помощью GCC
...
for %%F in (main ConsoleView DateTimeModel Presenter signal_impl console_settings_keeper) do (

...
public:
    ...
    // и запускает поток взаимодействия (showBanner + promptTimezone).
...
private:
    ...
    void handleTimezoneEntered();
    void handleModeSelected();
    void handleInputEntered();
    ...
    signals::SlotMethodImpl<Presenter>  m_slotTimezoneEntered;
    signals::SlotMethodImpl<Presenter>  m_slotModeSelected;
    signals::SlotMethodImpl<Presenter>  m_slotInputEntered;
    signals::SlotMethodImpl<Presenter>  m_slotResultReady;
